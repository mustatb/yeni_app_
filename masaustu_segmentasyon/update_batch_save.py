...
# Dosyayı oku
with open(r'c:\Users\Mustafa\Desktop\yeni_app\masaustu_segmentasyon\arayuz\ana_pencere.py', 'r', encoding='utf-8') as f:
    content = f.read()

# Eski maskeleri_toplu_kaydet fonksiyonunu bul ve değiştir
old_function_pattern = r'    def maskeleri_toplu_kaydet\(self\):.*?(?=\n    def |\nclass |\Z)'

new_function = '''    def maskeleri_toplu_kaydet(self):
        """
...
# Kaydet
with open(r'c:\Users\Mustafa\Desktop\yeni_app\masaustu_segmentasyon\arayuz\ana_pencere.py', 'w', encoding='utf-8') as f:
    f.write(new_content)
